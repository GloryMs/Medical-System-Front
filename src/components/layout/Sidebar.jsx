...
//           { name: 'Support & Complaints', href: '/patient/complaints', icon: AlertTriangle },
...
//           { name: 'Consultation Reports', href: '/doctor/reports', icon: FileText },
//           { name: 'Patient Communication', href: '/doctor/communication', icon: Bell },
