        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-gray-900">MediLink+ Germany</h1>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                rating: 5,
                comment: "MediLink+ made it possible for me to get a second opinion from German oncologists. The entire process was smooth and professional.",
                speciality: "Oncology"
              },
              {
                name: "Maria Petrova",
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <div className="flex items-center space-x-3 mb-6">
                ...
                <h3 className="text-xl font-bold">MediLink+ Germany</h3>
              </div>
          ...
          <div className="border-t border-gray-800 mt-12 pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center">
              <p className="text-gray-400">
                © 2024 MediLink+ Germany. All rights reserved.
              </p>
